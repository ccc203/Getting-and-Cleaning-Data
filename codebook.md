...
<div class="highlight highlight-source-r"><pre><span class="pl-smi">data2</span>[, .<span class="pl-smi">N</span>, <span class="pl-v">by</span> <span class="pl-k">=</span> c(names(<span class="pl-smi">dtTidy</span>)[grep(<span class="pl-s"><span class="pl-pds">"</span>^feat<span class="pl-pds">"</span></span>, names(<span class="pl-smi">data2</span>))])]</pre></div>
